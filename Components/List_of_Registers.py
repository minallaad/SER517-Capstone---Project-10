...
from PyQt5.QtWidgets import QWidget, QSplitter, QApplication, QHBoxLayout, QGroupBox, QFrame, QVBoxLayout, QScrollArea, \
    QListWidget, QMessageBox, QTableWidget, QTableWidgetItem
from PyQt5.QtGui import QPainter, QPen
from PyQt5.QtCore import Qt


class List_of_Registers(QtWidgets.QWidget):
    def __init__(self):
        super(List_of_Registers, self).__init__()
